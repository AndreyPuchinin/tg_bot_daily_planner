...
def info_handler(message):
    ...
    text = (
        "ℹ️ <b>Информация о боте «Ежедневник»</b>\n\n"+
        "<b>Для всех пользователей (кроме админов, для них - свои команды):</b>\n"+
        "<b><i>Для получения информации о возможностях для админов обратитесь к действующим админам<i><b>\n"+
        "• /start — начать работу с ботом\n"+
        "• /task — добавить новую задачу\n"+
        "• Задачи напоминаются автоматически:\n"+
        "  – за 12 часов до начала,\n"+
        "  – и за день в 13:00 по МСК.\n\n"
    )

    if is_admin:
        text += (
            "<b>Для администратора:</b>\n"+
            "• /jsonout — получить текущую БД в виде файла\n"+
            "• /jsonin — загрузить новую БД из файла\n"+
            "⚠️ Все операции с БД требуют корректного JSON-формата.\n"
        )
